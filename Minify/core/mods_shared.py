...
_always_on_mods: set[str] | None = None
_always_on_lock = threading.Lock()

mods_with_order: list[str] = []
visually_available_mods: list[str] = []
mod_dependencies_list: list[dict[str, Any]] = []
mod_conflicts_list: list[dict[str, Any]] = []
