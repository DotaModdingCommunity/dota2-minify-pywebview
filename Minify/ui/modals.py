...
from core import base, config, fs, log, net
...
class Update:
    ...
    def _download_thread(url: str) -> None:
        try:
            ...
            Update._download_with_progress(
                url, installer_path, "&status_launching_installer", post_download=lambda p: None
            )
            time.sleep(0.5)
